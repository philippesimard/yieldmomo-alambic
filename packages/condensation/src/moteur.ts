...
//
// Un fragment vu sans pouvoir etre lu se rend avec un texte vide, et non en le taisant : c'est
// la seule facon de distinguer un moteur qui ne voit plus rien d'un moteur qui ne lit plus
// rien. La Condensation les compte et les retire ; ils ne sortent jamais dans le condensat.
